...
def calculation_std(data):
    """
        Функция вычисляет скользящее стандартное отклонение в окне 5 для столбца «Close» во входном DataFrame.
        Результат добавляется как новый столбец «STD_5».
    Parameters:
        data(pd.DataFrame): DataFrame содержащий столбец 'Close'.
    Returns:
        None
    """
