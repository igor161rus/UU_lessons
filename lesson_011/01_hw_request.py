# Используя библиотеки request и github получите информацию о публичном репозитории github.com пользователя igor161rus
# Удачи
...
# Получаем веб-страницу с помощью get-запроса (токен можно не использовать - репозиторий публичный)
...
# Вывод
# C:\Python\Python38\python.exe C:\Python\Projects\UU_lessons\lesson_011\01_hw_request.py
# 200
...
# Дата последнего обновления: 2024-02-22 16:55:53+00:00
