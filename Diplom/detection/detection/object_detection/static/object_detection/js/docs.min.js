    ...
    return function(e) {
        ...
        function r() {
            if (null === document.head.querySelector("style.anchorjs")) {
                ...
                void 0 === (e = document.head.querySelector('[rel="stylesheet"], style')) ? document.head.appendChild(t) : document.head.insertBefore(t, e),
        ...
        this.add = function(e) {
            ...
            if (t(this.options),
            "touch" === (A = this.options.visible) && (A = this.isTouchDevice() ? "always" : "hover"),
            e || (e = "h2, h3, h4, h5, h6"),
            0 === (i = n(e)).length)
                return this;
            for (r(),
            ...
            l = 0; l < i.length; l++)
                if (this.hasAnchorJSLink(i[l]))
                    ...
                    if (i[l].hasAttribute("id"))
                        ...
                        d = h = this.urlify(i[l].textContent),
                        u = 0;
                        do {
                            void 0 !== c && (d = h + "-" + u),
                            c = a.indexOf(d),
                    ...
                    i[l].insertBefore(f, i[l].firstChild)) : (f.style.paddingLeft = "0.375em",
                    i[l].appendChild(f))
                }
        ...
        this.remove = function(e) {
            for (var t, r, i = n(e), o = 0; o < i.length; o++)
                (r = i[o].querySelector(".anchorjs-link")) && (-1 !== (t = this.elements.indexOf(i[o])) && this.elements.splice(t, 1),
                i[o].removeChild(r));
            return this
        }
        ,
        ...
        this.urlify = function(e) {
            ...
            e.trim().replace(/\'/gi, "").replace(n, "-").replace(/-{2,}/g, "-").substring(0, this.options.truncate).replace(/^-+|-+$/gm, "").toLowerCase()
        }
        ,
...
function(e, t) {
        ...
        (function(t) {
            ...
            function i(e, t) {
                ...
                2 === i.length) {
                    ...
                    if (n.auto = y.truthy(l.auto),
                    l.bg && (n.theme.bg = y.parseColor(l.bg)),
                    l.fg && (n.theme.fg = y.parseColor(l.fg)),
                    l.bg && !l.fg && (n.autoFg = !0),
                    l.theme && n.instanceOptions.themes.hasOwnProperty(l.theme) && (n.theme = k(n.instanceOptions.themes[l.theme], null)),
            ...
            function o(e) {
                ...
                !m.noFontFallback && "img" === n.nodeName.toLowerCase() && M.setup.supportsCanvas && "svg" === m.renderer && (m = k(m, {
                    renderer: "canvas"
                }))),
                r.font && "canvas" == m.renderer && (m.reRender = !0),
                "background" == t)
                    null == n.getAttribute("data-background-src") && w.setAttr(n, {
                ...
                "html" == m.renderer ? n.style.backgroundColor = s.bg : (a(b),
                "exact" == r.textmode && (n.holderData.resizeUpdate = !0,
                M.vars.resizableImages.push(n),
                c(n)))) : "background" == t && "html" != m.renderer ? a(b) : "fluid" == t && (n.holderData.resizeUpdate = !0,
                ...
                u(n),
                "html" == m.renderer ? n.style.backgroundColor = s.bg : (M.vars.resizableImages.push(n),
                c(n)))
            }
            function a(e) {
                function n() {
                ...
                l.noBackgroundSize || (o.style.backgroundSize = c.width + "px " + c.height + "px")) : ("img" === o.nodeName.toLowerCase() ? w.setAttr(o, {
                    src: r
                }) : "object" === o.nodeName.toLowerCase() && w.setAttr(o, {
                    data: r,
                    type: "image/svg+xml"
                }),
                l.reRender && t.setTimeout(function() {
                    ...
                    if (null == e)
                        throw "Holder: couldn't render placeholder";
                    "img" === o.nodeName.toLowerCase() ? w.setAttr(o, {
                        src: e
                    }) : "object" === o.nodeName.toLowerCase() && w.setAttr(o, {
                        data: e,
                        type: "image/svg+xml"
            ...
            function s(e) {
                ...
                if (g.lineCount > 1) {
                    ...
                    for (var C = 0; C < g.words.length; C++) {
                        ...
                        m = new s.Text(k.text);
                        var T = "\\n" == k.text;
                        !e.noWrap && (w + k.width >= o || T === !0) && (t(p, y, w, p.properties.leading),
                        p.add(y),
                        w = 0,
                    ...
                    if (t(p, y, w, p.properties.leading),
                    p.add(y),
                    "left" === e.align)
            ...
            function h() {
                ...
                r.forEach(function(t) {
                    ...
                    T(e) && "img" == e.nodeName.toLowerCase() && (n.push(e),
            ...
            function d() {
                M.vars.visibilityCheckStarted || (t.requestAnimationFrame(h),
                M.vars.visibilityCheckStarted = !0)
            }
            function f(e) {
                e.holderData.invisibleId || (M.vars.invisibleId += 1,
                M.vars.invisibleImages["i" + M.vars.invisibleId] = e,
                e.holderData.invisibleId = M.vars.invisibleId)
            }
            function A(e) {
                M.vars.debounceTimer || e.call(this),
                M.vars.debounceTimer && t.clearTimeout(M.vars.debounceTimer),
                M.vars.debounceTimer = t.setTimeout(function() {
                    M.vars.debounceTimer = null,
                    e.call(this)
                }, M.setup.debounce)
            }
            function p() {
            ...
            var g = n(2)
              ...
              , O = {
                ...
                addTheme: function(e, t) {
                    return null != e && null != t && (M.settings.themes[e] = t),
                ...
                run: function(e) {
                    ...
                    var n = {}
                      , a = k(M.settings, e);
                    M.vars.preempted = !0,
                    M.vars.dataAttr = a.dataAttr || M.setup.dataAttr,
                    n.renderer = a.renderer ? a.renderer : M.setup.renderer,
                    M.setup.renderers.join(",").indexOf(n.renderer) === -1 && (n.renderer = M.setup.supportsSVG ? "svg" : M.setup.supportsCanvas ? "canvas" : "html");
                    ...
                    u.forEach(function(e) {
                        ...
                        try {
                            ...
                            t.dataSrc = e.getAttribute(M.vars.dataAttr)
                        } catch (e) {}
                ...
                return function(r) {
                    ...
                    if (M.setup.supportsSVG) {
                        ...
                        var f = t.getComputedTextLength()
                          , A = c.width - f
                          , p = Math.round(A / Math.max(1, h.length - 1))
                          , g = [];
                        if (u > 1) {
                            n.nodeValue = "";
            ...
            for (var L in M.flags)
                M.flags.hasOwnProperty(L) && (M.flags[L].match = function(e) {
            ...
            function() {
                ...
                e.getContext && e.toDataURL("image/png").indexOf("data:image/png") != -1 && (M.setup.renderer = "canvas",
                M.setup.supportsCanvas = !0),
                document.createElementNS && document.createElementNS(j, "svg").createSVGRect && (M.setup.renderer = "svg",
                M.setup.supportsSVG = !0)
            }(),
            d(),
            g && g(function() {
                M.vars.preempted || O.run(),
                t.addEventListener ? (t.addEventListener("resize", p, !1),
                t.addEventListener("orientationchange", p, !1)) : t.attachEvent("onresize", p),
    ...
    , function(e, t) {
        ...
        e.exports = function(e) {
            ...
            return null === e ? "null" : void 0 === e ? "undefined" : e !== e ? "nan" : e && 1 === e.nodeType ? "element" : n(e) ? "buffer" : (e = e.valueOf ? e.valueOf() : Object.prototype.valueOf.apply(e),
            typeof e)
        }
    }
    , function(e, t) {
    ...
    , function(e, t) {
        (function(e) {
            ...
            t.parseColor = function(e) {
                ...
                return null !== o ? (t = o[1] || o[2],
                "#" !== t[0] ? "#" + t : t) : (o = e.match(r),
                null !== o ? t = "rgb(" + o.slice(1).join(",") + ")" : (o = e.match(i),
    ...
    , function(e, t, n) {
        ...
        e.exports = function() {
            ...
            return function(n) {
                ...
                t.font = h.properties.font.weight + " " + r * h.properties.font.size + h.properties.font.units + " " + h.properties.font.family + ", monospace",
                ...
                for (var d in h.children) {
                    ...
                    for (var A in f.children) {
                        var p = f.children[A]
                          , g = r * (h.x + f.x + p.x)
                          , m = r * (h.y + f.y + p.y + h.properties.leading / 2);
